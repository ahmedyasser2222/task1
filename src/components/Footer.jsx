...
export default function FooterComp() {
  return (
    ...
    >
      <div className="footer m-con">
        <div className="w-full flex flex-col md:flex-row justify-between px-5  py-5 in-footer">
          <div>
            <h2
              className="mb-6 text-base font-bold uppercase dark:text-gray-400 "
      ...
      <div className="end-footer">
          <div className="con-end-footer m-con">
              <div className="footer-end-top con-end-footer">
                <div className="app-download">
                  <button>
                    <img src="https://assets.zid.store/themes/f9f0914d-3c58-493b-bd83-260ed3cb4e82/app-store.svg" />
                  </button>
                  <button>
                    <img src="https://assets.zid.store/themes/f9f0914d-3c58-493b-bd83-260ed3cb4e82/google-play.svg" />
                  </button>
                </div>
                <div className="pay">
                  <button>
                  ...
                  <button>
                    <img
                      ...
                      src="https://media.zid.store/static/tabby2.svg"
                    />
                  </button>
                  <button>
                    <img
                      style={{ objectFit: "contain" }}
                      src="https://media.zid.store/cdn-cgi/image/h=80,q=85/https://media.zid.store/static/cod.png"
                    />
                  </button>
                </div>
              </div>
              ...
              <div className="dev">
                ...
                <button>
                  <img src="https://assets.zid.store/themes/f9f0914d-3c58-493b-bd83-260ed3cb4e82/maroof.png" />
                </button>
                  </div>
                  <div className="p" >
