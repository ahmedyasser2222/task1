...
import {AiOutlineShoppingCart , AiFillCaretDown ,AiFillCaretUp , AiOutlineSearch  ,AiFillCaretLeft ,AiFillCaretRight} from "react-icons/ai"
    ...
    <header className="fixed top-0 left-0 z-20 flex w-full flex-col" >
      ...
      <nav className={` flex-row sm:flex bg-prim border-b  login ${scrollY > 100 ? "hide" :""}`}>
         <div className="nav-top m-con">
          ...
          <button onClick={e=>showCountry()} className="px-4 py-1 border text-sm text-white border-white rounded-lg flex flex-row  items-center gap-2">
            <span>  
                السعودية
            </span>
          </button>
          ...
          <div className={`m-con`}>
                <div className="div-links" style={{width:'100%'}} >
                       {/* <div className="hide-menu"  onClick={e=>setShowMenu(!showMenu)} >
                        ...
                        <div className="back-icon"  id="back" 
                        onClick={e=>{
                         ...
                         <GrLinkNext className="hide-icon" style={{color:'white !important'}} />
                        </div>
              ...
              <li>
                <a onClick={e=>navigate('/categories')}>
                    جميع التصنيفات 
                </a>
              </li>
              <div className="btn">
      ...
      <div className="body-country" onClick={e=>showCountry()}> </div>
  
           <div className="country">
              <div className="top-country">
                  <p>الدولة</p>
                  <p onClick={e=>showCountry()}> <GiCancel /> </p>
              </div>
              <div className="menu">
                      <select name="" id="">
